      ...
      <nav className="max-w-7xl mx-auto flex justify-between items-center">
        <Link href="/" className="group transition-all">
          <div className="flex items-center justify-center font-semibold gap-1 sm:gap-2">
            ...
            <h1 className="text-xl sm:text-2xl font-serif text-zinc-900 dark:text-white font-bold tracking-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
              StartHub
            </h1>
          </div>
        </Link>
