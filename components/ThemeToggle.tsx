...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-10 h-10 rounded-md  bg-white dark:bg-zinc-950 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors relative overflow-hidden"
